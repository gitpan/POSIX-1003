...
The POSIX module in Core (distributed with Perl itself) is ancient,
...
The POSIX standard is large, over 1200 functions; L<POSIX::Overview|POSIX::Overview>
...
=item L<POSIX::1003::FileSystem|POSIX::1003::FileSystem>
...
With helper modules L<POSIX::SigSet|POSIX::SigSet> and L<POSIX::1003::SigAction|POSIX::1003::SigAction>.
