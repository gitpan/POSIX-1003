...
=head2 Math constants from float.h or limits.h
...
=head2 Math constants from math.h

 HUGE_VAL

=head2 Math constants from stdlib.h

 RAND_MAX

=head2 Math related constants in limits.h
