...
This module is part of POSIX-1003 distribution version 0.94_3,
built on June 10, 2013. Website: F<http://perl.overmeer.net>.  The code is based on L<POSIX>, which
