...
The L<POSIX::1003|POSIX::1003> suite implements access to many POSIX functions. It
...
This module is part of POSIX-1003 distribution version 0.06,
built on December 25, 2011. Website: F<http://perl.overmeer.net>.  The code is based on L<POSIX>, which
